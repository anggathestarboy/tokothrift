...
<body>
    ...
    <div class="sidebar fixed inset-y-0 left-0 w-64 z-50" id="sidebar">
        <div class="flex flex-col h-full">
            ...
            <nav class="flex-1 p-4 space-y-2">
                <a href="{{ route('admin.admin') }}" class="menu-item flex items-center px-4 py-3 text-sm text-gray-300">
                    <svg class="icon mr-3" viewBox="0 0 24 24">
                        <path d="M3 13h8V3H3v10zm0 8h8v-6H3v6zm10 0h8V11h-8v10zm0-18v6h8V3h-8z"/>
                    </svg>
                    Dashboard
                </a>
                <a href="{{  route('admin.pakaian.index')}}" class="menu-item flex items-center px-4 py-3 text-sm text-gray-300">
                    <svg class="icon mr-3" viewBox="0 0 24 24">
                ...
                <a href="{{ route('admin.pembelian') }}" class="menu-item flex items-center px-4 py-3 text-sm text-gray-300">
                    <svg class="icon mr-3" viewBox="0 0 24 24">
                        <path d="M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zM9 17H7v-7h2v7zm4 0h-2V7h2v10zm4 0h-2v-4h2v4z"/>
                    </svg>
                    Pembelian
                </a>
                <a href="{{ route('admin.category') }}" class="menu-item flex items-center px-4 py-3 text-sm text-gray-300">
                    <svg class="icon mr-3" viewBox="0 0 24 24">
                        <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-2 15l-5-5 1.41-1.41L10 14.17l7.59-7.59L19 8l-9 9z"/>
                    </svg>
                    Kategori
                </a>
                <a href="{{ route('profile.index') }}" class="menu-item flex items-center px-4 py-3 text-sm text-gray-300">
                    <svg class="icon mr-3" viewBox="0 0 24 24">
    ...
    <a href="{{ url('/admin/profile') }}" class="flex items-center space-x-2 user-info">
    @if(Auth::user()->user_profil_url) 
        ...
        >
    @else
        <!-- Jika tidak ada foto profil, pakai default inisial -->
